...
<li><a href="<?php echo U('Uploader/Blog/forumManege');?>">板块列表</a></li>
</ul>
<div class="container" >
<div  class="col-md-11">
	<div class="panel panel-default" >
		...
		<div class="panel-body ">
			...
			<table  class="table table-hover student-detail table-display" id="forum_table" >
				<thead>
				<tr>
					<th>序号</th>
					<th>板块名</th>
				...
				<tbody>
				<?php if(is_array($forumList)): foreach($forumList as $k=>$forum): ?><tr >
						<td><?php echo ($k); ?></td>
						<td><?php echo ($forum["name"]); ?></td>
						<td><?php echo ($forum["forum_id"]); ?></td>
						<td><?php echo ($forum["count"]); ?></td>
						<td><?php echo ($forum["updatetime"]); ?></td>
						<td><a class="btn btn-info" href="<?php echo U('Article/listView');?>?forum_id=<?php echo ($forum["forum_id"]); ?>">查看</a></td>
