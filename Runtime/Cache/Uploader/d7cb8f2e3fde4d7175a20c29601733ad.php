	...
	<div class="panel panel-default" >
		...
		<div class="panel-body ">
			...
			<table  class="table table-hover student-detail table-display" id="forum_table" >
				...
				<tbody>
				<?php if(is_array($forumList)): foreach($forumList as $k=>$forum): ?><tr id="<?php echo ($forum["forum_id"]); ?>">
						<td><?php echo ($k); ?></td>
						<td><?php echo ($forum["name"]); ?></td>
						<td><?php echo ($forum["forum_id"]); ?></td>
						<td><?php echo ($forum["count"]); ?></td>
						<td><?php echo ($forum["updateTime"]); ?></td>
						<td><a class="btn btn-info"> 编辑</a></td>
...
<script type="text/javascript">
	$(function(){
		...
		$("tr").click(function(){
			var  $id=$(this).attr("id")
			alert($id);
			location.href = '<?php echo U("Article/listView");?>'+"?forum_id="+$id;//
		});
	});
