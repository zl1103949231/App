...
<div data-role="page" id="pageone" data-theme="b">
    ...
    <div data-role="content">
        <form method="post" action="<?php echo ($_SERVER['PHP_SELF']); ?>/update" data-ajax="false" >
            ...
            <label for="except_birthday">预产期：</label>
            <input type="date" name="except_birthday"  id="except_birthday" value="<?php echo ($except_birthday); ?>" placeholder="<?php echo ($except_birthday); ?>"/>
